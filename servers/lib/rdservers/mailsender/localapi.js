...
MailsenderLocalApi.prototype = {
  /**
   * @args[
   *   @param[transitEnvelope PersonTransitEnvelope]
   * ]
   */
  sendTransitEnvelopeToServer: function(transitEnvelope) {
    if (transitEnvelope.recipKey === this._config.keyring.boxingPublicKey) {
